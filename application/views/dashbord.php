...
<body>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="<?php echo base_url()?>edit_admin"><i class="icon-eye-open"></i><span class="hidden-tablet"> Add Admin</span></a></li>
						<li><a href="<?php echo base_url()?>manage_admin"><i class="icon-tasks"></i><span class="hidden-tablet"> Manage Admin</span></a></li>
	...
	$(document).on("click","#delete",function(e){
		...
		bootbox.confirm("Are you wanted to delete !!",function(confirm) {
			if(confirm)
			{
