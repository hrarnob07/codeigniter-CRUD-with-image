...
<body>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a href="<?php echo base_url()?>dashbord"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Dashboard</span></a></li>	
						<li><a href="<?php echo base_url()?>add_student"><i class="icon-envelope"></i><span class="hidden-tablet"> Add Student</span></a></li>
						<li><a href="<?php echo base_url()?>manage_student"><i class="icon-tasks"></i><span class="hidden-tablet"> Manage student</span></a></li>
						<li><a href="<?php echo base_url()?>edit_admin"><i class="icon-eye-open"></i><span class="hidden-tablet"> Admin</span></a></li>
	...
	<form class="form-horizontal" action="<?php echo base_url()?>update_student_data" method="post">
							<fieldset>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge " id="disabledInput" type="text" name="student_name" value="<?php echo $all_student_for_update->student_name?>" >
								</div>
							  </div>
							   ...
							   <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge " id="disabledInput" type="hidden" name="student_id" value="<?php echo $all_student_for_update->student_id?>" >
								</div>
							  </div>
							   ...
							   <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" id="focusedInput" type="text" name="student_dept" value="<?php echo $all_student_for_update->student_dept?>">
								</div>
							  </div>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge " id="disabledInput" type="text" name="student_cgpa" value="<?php echo $all_student_for_update->student_cgpa?>" >
								</div>
							  </div>
